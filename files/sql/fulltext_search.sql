...
SET @index_exists = (
    ...
    AND table_name = 'olist_products' 
    AND index_name = 'idx_product_category'
);

SET @sql = IF(@index_exists = 0,
    'ALTER TABLE olist_products ADD FULLTEXT INDEX indx_product_category (product_category_name)',
...
SHOW INDEX FROM olist_products;

-- Check table status
SELECT 'Table Status:' as section;
SHOW TABLE STATUS LIKE 'olist_products';
